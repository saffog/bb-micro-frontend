...
import "./index.scss";
import LabelForm from "./components/atoms/label";
import IconForm from "./components/atoms/icon";
import IconLabelForm from "./components/molecules/icon-label";
import AccountCardForm from "./components/organisms/account-card";
...
const App = () => (
  <div className="App mt-3 bg-gray-50">
    <div class="mx-auto p-6 pt-0 sm:max-w-5xl">
      ...
      <div>
        Ejemplo de label: <LabelForm name="experimento" value="Tiene valor!!" tailwindStyle="text-yellow-400"></LabelForm>
        Ejemplo de Icon: <IconForm styleIcon={icon({name: 'user'})}/>
        Ejemplo de IconLabel: <IconLabelForm name="otro" value={`Tieno otro valor`} styleIcon={icon({name: 'user'})} 
        tailwindStyle="text-red-400"/>
        Ejemplo de AccountCard <AccountCardForm 
